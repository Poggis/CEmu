...
_Acknowledgements_: Some CEmu parts are, directly, modified, or inspired, from [z80e](https://github.com/KnightOS/z80e), [Firebird](https://github.com/nspire-emus/firebird), [libtifiles](https://github.com/debrouxl/tilibs), [tivars_lib_cpp](https://github.com/adriweb/tivars_lib_cpp), antony jr's [QArchive](https://github.com/antony-jr/QArchive), [Sol 2](https://github.com/ThePhD/sol2), and FatCow's ["Farm-Fresh Web Icons"](http://www.fatcow.com/free-icons).
